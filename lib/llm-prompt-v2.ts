...
**IMPORTANT :** Dans le résumé client, référez-vous à l'appareil comme "l'ascenseur ${data.unitName}" ou "${data.unitName}" - N'utilisez PAS "à l'appareil" ou "à" avant le nom de l'appareil.`
