  ...
  return (
    <aside className="w-64 bg-slate-800 text-white flex flex-col h-screen flex-shrink-0" suppressHydrationWarning>
      ...
      <nav className="flex-1 p-4 overflow-y-auto">
        ...
        {/* Admin Tools Section - Smooth transition to prevent flicker */}
        <div 
          className={`pb-4 mt-6 transition-all duration-200 ${
            isAdmin && hasCheckedAdmin ? 'opacity-100 max-h-96' : 'opacity-0 max-h-0 overflow-hidden pointer-events-none'
          }`}
